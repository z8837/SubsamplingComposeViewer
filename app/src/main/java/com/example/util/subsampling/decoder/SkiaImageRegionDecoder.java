...
import com.example.util.subsampling.SubsamplingScaleImageView;
...
public class SkiaImageRegionDecoder implements ImageRegionDecoder {
    ...
    private String TAG = "SkiaImageRegionDecoder";
    ...
    public SkiaImageRegionDecoder(@Nullable Bitmap.Config bitmapConfig) {
        ...
        if (bitmapConfig != null) {
            Log.e("SkiaImageRegionDecoder","bitmapConfig != null");
            this.bitmapConfig = bitmapConfig;
        } else if (globalBitmapConfig != null) {
            Log.e("SkiaImageRegionDecoder","globalBitmapConfig != null");
            this.bitmapConfig = globalBitmapConfig;
        } else {
            Log.e("SkiaImageRegionDecoder","else");
